...
```{r, echo=FALSE, message=FALSE}
lyrics <- read_csv("../diss_tracks.csv")
eras <- read_csv("../kendrick_modularity_with_eras.csv")
```

## Introduction

![Lyricism by Genre](genres-lyricism.png)
...
![Drake's Lyrics Network](drake_network.png)

![Kendrick's Lyrics Network](kendrick_network.png)
...
![Drake's Top Ten Words](drake-top-ten.png)

![Kendrick's Top Ten Words](kendrick-top-ten.png)
